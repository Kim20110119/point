 ...
 *
 */
public class Chance_Election extends Pc_Chance {
	/** 「daily-points」 */
	...
	public Integer execute() {
		try {
			// 「クマクマ総選挙URL」取得する
			election_url = driver.findElement(By.className(C_D_P)).findElements(By.tagName(T_A)).get(INT_4)
					.getAttribute(A_HREF);
