 ...
 *
 */
public class Nyandaful_Election extends Pc_Nyandaful {
	/** 「daily-points」 */
	 ...
	 * コンストラクタ
	 */
	public Nyandaful_Election() {
		// 「CMくじ」
		driver.get(PC_CM_URL);
		driver.findElement(By.name("frmstamp")).submit();
	...
	public Integer execute() {
		try {
			// 「クマクマ総選挙URL」取得する
			election_url = driver.findElement(By.className(C_D_P)).findElements(By.tagName(T_A)).get(INT_5)
					.getAttribute(A_HREF);
